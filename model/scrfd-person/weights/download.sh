...
# 用法: ./download.sh
FILE_NAME="scrfd_person_2.5g.onnx"
URL="https://drive.google.com/file/d/1Ao5qXYeJk12QFw57y8kiERamAkd2Uh4W/view?usp=sharing"

# 是否跳过证书验证
SKIP_CERT="${INSECURE:-false}"

echo "📥 准备下载 ${FILE_NAME} (从 HuggingFace)..."
